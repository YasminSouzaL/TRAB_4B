...
?>
	...
	<center>
		<main>
		<br>
		<h1 class="text-center"><strong>Alterar Nome </strong> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="senha"><h4>Novo Nome:</h4></label>
				<input type="text" class="form-control" name="nome" value="<?=$_SESSION['nome']?>">
			</div>
		
        
			<label ><h4>Deseja mesmo alterar nome ?</h4></label>
